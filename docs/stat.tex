...
\input{proportion_test.tex}

\input{t_test.tex}

\input{poisson_test.tex}

\input{equivalence_test.tex}

\input{non_inferiority_test.tex}

\input{mann_whitney_u_test.tex}

\input{multiple_test.tex}
